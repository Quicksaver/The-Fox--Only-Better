# Beyond Australis
A Firefox add-on to improve the feeling of using the new Australis theme. Find more information and get the latest version at https://addons.mozilla.org/firefox/addon/the-fox-only-better/
...
2. Register as translator for the add-on: https://www.babelzilla.org/index.php?option=com_wts&Itemid=0&type=show&extension=5716
