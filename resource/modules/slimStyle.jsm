...
this.AUSTRALIS_BORDER_CURVE1_X1 = 0.55;
this.AUSTRALIS_BORDER_CURVE1_Y1 = -0.02;
this.AUSTRALIS_BORDER_CURVE1_X2 = 0.48;
this.AUSTRALIS_BORDER_CURVE1_Y2 = 0.5;

this.AUSTRALIS_BORDER_CURVE2_X1 = 0.52;
this.AUSTRALIS_BORDER_CURVE2_Y1 = 0.5;
this.AUSTRALIS_BORDER_CURVE2_X2 = 0.45;
this.AUSTRALIS_BORDER_CURVE2_Y2 = 1.02;
...
this.slimChromeClipPaths = function() {
	...
	d += " "+(((1-AUSTRALIS_BORDER_COORD_X2)*aC)+aC+bC)+","+AUSTRALIS_BORDER_COORD_Y2;
	d += " "+(((1-AUSTRALIS_BORDER_CURVE1_X2)*aC)+aC+bC)+","+AUSTRALIS_BORDER_CURVE1_Y2;
	d += " "+(((1-AUSTRALIS_BORDER_CURVE1_X1)*aC)+aC+bC)+","+AUSTRALIS_BORDER_CURVE1_Y1;
